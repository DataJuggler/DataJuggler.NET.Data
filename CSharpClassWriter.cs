...
namespace DataJuggler.NET.Data
{
	...
	{  
        ...
        private const string DelegatesReference = "DataJuggler.NET.Data.Delegates";
        private const string EnumerationsReference = "DataJuggler.NET.Data.Enumerations";
        #endregion
		...
		#region Methods
            ...
            #region CloneField(DataJuggler.NET.Data.DataField field,string newObjectName)
            public string CloneField(DataJuggler.NET.Data.DataField field,string newObjectName)
			{
                // local
                    ...
                    else
                    {
                        ...
                        switch (field.DataType)
				        {
					        ...
					        case DataManager.DataTypeEnum.DataTable:
						        ...
						        dataType =  "DataJuggler.NET.Data.DataTable";
			...
			#region CreateForEach(DataJuggler.NET.Data.DataTable table)
			/// <summary>
			/// This method creates a foreach for each field in the table
			/// </summary>
			/// <param name="table"></param>
			/// <returns></returns>
			public string CreateForEach(DataJuggler.NET.Data.DataTable table)
			{
            ...
            #region GetCompareLine(DataJuggler.NET.Data.DataTable table, string primaryKeyName)
            /// <summary>
            ...
            /// <returns></returns>
            public string GetCompareLine(DataJuggler.NET.Data.DataTable table, string primaryKeyName)
			{
			...
			public void InitializeStrings(List<DataField> fields)
			{
				...
				foreach(DataJuggler.NET.Data.DataField field in fields)
				{
			...
			#region LoadField(DataJuggler.NET.Data.DataField field)
			public string LoadField(DataJuggler.NET.Data.DataField Field)
			{
				// String Builder  
				StringBuilder sb = new StringBuilder("this.");
			...
			#region NullField(DataJuggler.NET.Data.DataField field)
			public string NullField(DataJuggler.NET.Data.DataField Field)
			{
				// Create StringBuilder
            ...
            #region ParseFieldValue(DataJuggler.NET.Data.DataField field)
            /// <summary>
            /// Parse the field value
            /// </summary>
            /// <param name="field"></param>
            /// <returns></returns>
            public string ParseFieldValue(DataJuggler.NET.Data.DataField field)
			{
				// Create StringBuilder Object
				StringBuilder sb = new StringBuilder();
			...
			#region SaveObject(DataJuggler.NET.Data.DataTable table)
			/// <summary>
			...
			/// <param name="table"></param>
			/// <returns></returns>
			public string SaveObject(DataJuggler.NET.Data.DataTable table)
			{
				// Create New Object Name
			...
			#region UpdateLine(DataJuggler.NET.Data.DataField field)
			public string UpdateLine(DataJuggler.NET.Data.DataField Field)
			{
			...
			private void WriteAddMethod(DataJuggler.NET.Data.DataTable table)
			{
			...
			{	
				// Write Each Class
				foreach(DataJuggler.NET.Data.DataTable table in tables)
				{
			...
			private void WriteConstructor(DataJuggler.NET.Data.DataTable table)
			{
			...
			#region WriteCreateTableMethod(DataJuggler.NET.Data.DataTable table)
			private void WriteCreateTableMethod(DataJuggler.NET.Data.DataTable table)
			{
				...
				// Write BeginRegion "CreateTable(DataJuggler.NET.Data.DataTable table)";
				line = "CreateTable(DataJuggler.NET.Data.DataTable table)";
				BeginRegion(line);

				// Write Method Name
				line = "private void CreateTable(DataJuggler.NET.Data.DataTable table)";
				WriteLine(line);
				...
				// Instanciate table
				line = "this.table = new DataJuggler.NET.Data.DataTable();";
				WriteLine(line);

				// Create field For Adding To Fields Collection
				line = "DataJuggler.NET.Data.DataField field = new DataJuggler.NET.Data.DataField();";
				WriteLine(line);
				...
				foreach(DataJuggler.NET.Data.DataField Field in table.ActiveFields)
				{
					// Write Blank Line
					WriteLine();
					...
					line = "field = new DataJuggler.NET.Data.DataField();";
					WriteLine(line);
			...
			#region WriteDataClassVariables(DataJuggler.NET.Data.DataTable table)
			private void WriteDataClassVariables(DataJuggler.NET.Data.DataTable table)
			{
				// local StringBuilder
				StringBuilder sb = new StringBuilder();
			...
			#region WriteDeleteChanges(DataJuggler.NET.Data.DataTable table)
			private void WriteDeleteChanges(DataJuggler.NET.Data.DataTable table)
			{
			...
			private void WriteExportToDataRowMethod(DataJuggler.NET.Data.DataTable dataTable)
			{
				...
				// Create row
				DataJuggler.NET.Data.DataRow dataRow = new DataRow(dataTable);
			...
			#region WriteGetIndex(DataJuggler.NET.Data.DataTable table)
			private void WriteGetIndex(DataJuggler.NET.Data.DataTable table)
			{
			...
			#region WriteInitialChanges(DataJuggler.NET.Data.DataTable table)
			private void WriteInitialChanges(DataJuggler.NET.Data.DataTable table)
			{
			...
			#region WriteLoadMethodFromDataRow(DataJuggler.NET.Data.DataTable table)
			private void WriteLoadMethodFromDataRow(DataJuggler.NET.Data.DataTable table)
			{
				// Local Variable
				string line = "";
			...
			#region WriteLoadMethods(DataJuggler.NET.Data.DataTable table)
			private void WriteLoadMethods(DataJuggler.NET.Data.DataTable table)
			{	
			...
			#region WriteMethods()
			private void WriteMethods(DataJuggler.NET.Data.DataTable table)
			{
				// Begin Region Constructor
				BeginRegion("Methods");
			...
			#region WriteProperties(DataJuggler.NET.Data.DataTable table) void
			private void WriteProperties(DataJuggler.NET.Data.DataTable table)
			{
			...
			public void WriteReferences(ReferencesSet references, bool requireDelegatesReference = false)
			{
                ...
                try
                {
                    ...
                    {  
                        ...
                        // if this reference name equals DataJuggler.NET.Data.Delegates
                        ...
                        // if this reference name equals DataJuggler.NET.Data.Enumerations
                    ...
                    if ((requireDelegatesReference) && (!hasDelegateReference))
                    {
                        ...
                        // write out the reference for DataJuggler.NET.Data.Delegates
                    ...
                    if ((requireDelegatesReference) && (!hasEnumerationsReference))
                    {
                        ...
                        // write out the reference for DataJuggler.NET.Data.Enumerations
                        WriteReference(referenceObject);
                    }
