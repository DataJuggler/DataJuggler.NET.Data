...
namespace DataJuggler.NET.Data
{
	...
	public class DataRow
	{
		...
		private int index;
		private DataJuggler.NET.Data.DataTable parentTable;
		private string tag;
		#endregion
		...
		#region Constructor
			...
			#region DataRow(DataJuggler.NET.Data.DataTable ParentDataTable)
			public DataRow(DataJuggler.NET.Data.DataTable ParentDataTable)
			{
				// Set Parent table
		...
		#region Methods
			...
			#region PrimaryKey()
			public DataJuggler.NET.Data.DataField PrimaryKey()
			{
				// Create DataField 
				DataJuggler.NET.Data.DataField NoField = new DataField();
				NoField.FieldName = "void";

				// Search For PrimaryKey
				foreach(DataJuggler.NET.Data.DataField Field in this.Fields)
				{
		...
		#region Properties
			...
			#region ParentTable
			public DataJuggler.NET.Data.DataTable ParentTable
			{
				get
				{
					return parentTable;
