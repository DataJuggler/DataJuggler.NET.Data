		...
		#region Methods
            ...
            public bool ContainsBinaryData
            {
                get
                {
                    ...
                    foreach(DataField dataField in this.ActiveFields)
                    {
                        // This is a binary field
                        if(dataField.DataType == DataManager.DataTypeEnum.Binary)
                        {
		...
		#region Properties
			...
			public bool Changes
			{
				get
				{
					...
					foreach(DataJuggler.NET.Data.DataRow Row in this.Rows)
					{
						if(Row.Changes)
						{
							return true;
			...
			public DataField PrimaryKey
			{
				get
				{
					...
					{
					    // Check Each field
					    foreach(DataJuggler.NET.Data.DataField dataField in this.ActiveFields)
					    {
