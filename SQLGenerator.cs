...
namespace DataJuggler.NET.Data
{
	...
	public class SQLGenerator
	{
		...
		#region Methods
			...
			#region BuildFieldClause(DataJuggler.NET.Data.DataField field)
			public string BuildFieldClause(DataJuggler.NET.Data.DataRow FieldRow, DataJuggler.NET.Data.DataField Field, int FieldCount)
			{
				// if FieldCount > 0
			...
			#region BuildWhereClause(DataJuggler.NET.Data.DataRow row)
			public string BuildWhereClause(DataJuggler.NET.Data.DataRow Row)
			{
				...
				foreach(DataJuggler.NET.Data.DataField Field in Row.Fields)
				{
			...
			#region CreateDeleteSQL(DataJuggler.NET.Data.DataRow row)
			public string CreateDeleteSQL(DataJuggler.NET.Data.DataRow Row)
			{
			...
			#region CreateInsertSQL(DataJuggler.NET.Data.DataRow row) +1 override
			
				#region CreateInsertSQL(DataJuggler.NET.Data.DataRow row)
				public string CreateInsertSQL(DataJuggler.NET.Data.DataRow Row)
				{
				...
				#region CreateInsertSQL(DataJuggler.NET.Data.DataRow row, bool WithOrWithoutChanges)
				public string CreateInsertSQL(DataJuggler.NET.Data.DataRow Row, bool WithOrWithoutChanges)
				{
			...
			#region CreateSelectAllSQL(DataJuggler.NET.Data.DataTable table) 
			/// <summary>
			...
			public string CreateSelectAllSQL(DataJuggler.NET.Data.DataTable dataTable)
			{		
			...
			#region CreateSelectSQL(DataJuggler.NET.Data.DataTable table, int primaryKeyValue) +3 overrides
			
				#region CreateSelectSQL(DataJuggler.NET.Data.DataTable table, int primaryKeyValue) 
				/// <summary>
				...
				/// </summary>
				/// <param name="table">DataJuggler.NET.Data.DataTable</param>
				...
				public string CreateSelectSQL(DataJuggler.NET.Data.DataTable table, int primaryKeyValue)
				{
				...
				#region CreateSelectSQL(DataJuggler.NET.Data.DataTable table, double primaryKeyValue) 
				/// <summary>
				/// Returns a valid sql statement to load an object from a table based upon the primary key.
				/// This is for a single field primary key.
				/// </summary>
				...
				/// <returns>A valid sql statement if the table has a primary key</returns>
				public string CreateSelectSQL(DataJuggler.NET.Data.DataTable table, double primaryKeyValue)
				{
					// Verify table Has A Primary Key
					if(table.PrimaryKey != null)
					{
				...
				#region CreateSelectSQL(DataJuggler.NET.Data.DataTable table, string primaryKeyValue) 
				/// <summary>
				/// Returns a valid sql statement to load an object from a table based upon the primary key.
				/// This is for a single field primary key.
				/// </summary>
				...
				/// <returns>A valid sql statement if the table has a primary key</returns>
				public string CreateSelectSQL(DataJuggler.NET.Data.DataTable table, string primaryKeyValue)
				{
					// Verify table Has A Primary Key
					if(table.PrimaryKey != null)
					{
				...
				#region CreateSelectSQL(DataJuggler.NET.Data.DataTable table, string fieldName, string fieldValue) 
				/// <summary>
				...
				public string CreateSelectSQL(DataJuggler.NET.Data.DataTable table, string fieldName, string fieldValue)
				{
					// bool UseQuotes
			...
			#region CreateUpdateSQL(DataJuggler.NET.Data.DataRow row)
			public string CreateUpdateSQL(DataJuggler.NET.Data.DataRow Row)
			{
				// Boolean For Is This The First field
				bool FirstField = true;
			...
			public bool IsString(DataJuggler.NET.Data.DataTable table, string fieldName)
			{
                // initial value
                bool isString = false;
                
				// Create Generic row
				DataJuggler.NET.Data.DataRow row = new DataRow();
			...
			#region IsUpdateable(DataJuggler.NET.Data.DataRow row)
			public bool IsUpdateable(DataJuggler.NET.Data.DataRow Row)
			{
                // Initial Value
                bool updateable = false;

				// Check If There Is A PrimaryKey
				DataJuggler.NET.Data.DataField PrimaryKey = Row.PrimaryKey();
