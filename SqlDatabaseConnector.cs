...
namespace DataJuggler.NET.Data
{
    ...
    public class SQLDatabaseConnector
	{
		...
		#region Methods
			...
			#region BuildTableSQL(DataJuggler.NET.Data.DataTable dataTable)
			public string BuildTableSQL(DataJuggler.NET.Data.DataTable dataTable)
			{
			...
			#region IsPrimaryKeyUpdateable(DataJuggler.NET.Data.DataTable table)
			/// <summary>
			...
			public bool IsPrimaryKeyUpdateable(DataJuggler.NET.Data.DataTable table)
			{
			...
			#region LoadDataRows() +1 overrides
				...
				#region LoadDataRows(DataJuggler.NET.Data.DataTable table)
				/// <summary>
				/// Loads All Rows For This table
				/// </summary>
				/// <param name="table"></param>
				/// <returns></returns>
				public List<DataRow> LoadDataRows(DataJuggler.NET.Data.DataTable dataTable)
				{
				...
				#region LoadDataRows(DataJuggler.NET.Data.DataTable table, string sql)
				/// <summary>
				...
				/// <param name="sql"></param>
				/// <returns></returns>
				public List<DataRow> LoadDataRows(DataJuggler.NET.Data.DataTable dataTable, string sql)
				{	
                ...
                public List<DataRow> LoadDataRowsWithoutBinaryData(DataTable dataTable, string sql = "")
                {
                    ...
                    try
                    {
                        ...
                        foreach (System.Data.DataRow tempDataRow in dataSet.Tables[dataTable.Name].Rows)
                        {
                            ...
                            // Create A New row
                            dataRow = new DataJuggler.NET.Data.DataRow(dataTable);

                            // Clone Fields Collection For This row
                            dataRow.Fields = CloneFields(dataTable.ActiveFields);

                            // Add Each field
                            foreach (DataJuggler.NET.Data.DataField field in dataTable.Fields)
                            {
            ...
            public List<DataTable> LoadDataTablesSchema(Database parentDatabase)
			{
				...
				{				
					...
					{	
						// Create A New table
						DataJuggler.NET.Data.DataTable dataTable = new DataJuggler.NET.Data.DataTable();
            ...
            public DataJuggler.NET.Data.DataTable LoadDataTableSchema(Database parentDatabase, string tableName)
            {
                // initial value
                ...
                try
                {
                    ...
                    {
                        // Create A New table
                        DataJuggler.NET.Data.DataTable dt = new DataJuggler.NET.Data.DataTable();
			...
			public List<StoredProcedure> LoadStoredProcedures(List<DataTable> tables)
			{
				...
				try
				{
					...
					foreach(System.Data.DataRow dr in ds.Tables["Procedures"].Rows)
					{
						...
						DataJuggler.NET.Data.StoredProcedure sp = new StoredProcedure();
